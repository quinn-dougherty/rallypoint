  ...
  return (
    <div>
      <button
        ...
        disabled={isLinked}
      >
        {isLinked ? "Linked" : "Link Lesswrong Account"}
      </button>

      {showSignInDialog && (
        <div className="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-60 transition-opacity duration-300">
